 ...
 */
function alertV2() {
    let baseURL = '/v2/alerts/';
    let savedSearchbaseURL = baseURL + "saved-searches/";
    let closeActionPath = "/close/";
    let acknowledgeActionPath = "/acknowledge/";
    let unAcknowledgeActionPath = "/unacknowledge/";
    let addNoteActionPath = "/notes/";
    let snoozeActionPath = "/snooze/";
    let escalateToNextActionPath = "/escalate/";
    let assignActionPath = "/assign/";
    let addTeamActionPath = "/teams/";
    let tagsActionPath = "/tags/";
    let detailsActionPath = "/details/";
    let customActionPath = "/actions/";
    let recipientsPath = "/recipients/";
    let listLogsPath = "/logs/";
    let listNotesPath = "/notes/";
    ...
    return {
        ...
        * */
        getRequestStatus: function (requestId, config, cb) {
            let path = baseURL + "requests/" + requestId;
            api.get(path, config, cb)
        },
        ...
        * */
        ...
        acknowledge: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, acknowledgeActionPath);
        ...
        close: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, closeActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        addNote: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, addNoteActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        unacknowledge: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, unAcknowledgeActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        snooze: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, snoozeActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        escalateToNext: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, escalateToNextActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        assign: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, assignActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        addTeam: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, addTeamActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        addTags: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, tagsActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        removeTags: function (identifier, data, config, cb) {
            ...
            let path = api.getPathWithData(baseURL, identifier, tagsActionPath, data);
            api.delete(path, config, cb);
        },
        /**
        ...
        addDetails: function (identifier, data, config, cb) {
            let path = api.getPath(baseURL, identifier, detailsActionPath);
            api.post(path, data, config, cb);
        },
        /**
        ...
        removeDetails: function (identifier, data, config, cb) {
            ...
            let path = api.getPathWithData(baseURL, identifier, detailsActionPath, data);
            api.delete(path, config, cb);
        },
        /**
        ...
        executeAction: function (identifier, data, config, cb) {
            ...
            let path = api.getPath(baseURL, identifier, customActionPath + data.action);
            api.post(path, data, config, cb);
        },
        /**
        ...
        listAlertRecipients: function (identifier, config, cb) {
            let path = api.getPath(baseURL, identifier, recipientsPath);
            api.get(path, config, cb);
        },
        /**
        ...
        listAlertLogs: function (identifier, data, config, cb) {
            let path = api.getPathWithData(baseURL, identifier, listLogsPath, data);
            api.get(path, config, cb);
        },
        /**
        ...
        listAlertNotes: function (identifier, data, config, cb) {
            let path = api.getPathWithData(baseURL, identifier, listNotesPath, data);
            api.get(path, config, cb);
        },
        /**
        ...
        getSavedSearch: function (identifier, config, cb) {
            let path = api.getPath(savedSearchbaseURL, identifier, null);
            api.get(path, config, cb)
        },
        /**
